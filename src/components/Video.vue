    ...
    <div class="container">
      ...
      <div class="main-col">
        <div class="media-list loadmore">
          <div class="story story--video" v-for="content in (videoData.content || '').slice(0, 9)" :key="content.id">
          ...
          <div class="sidebar">
            <div class="rightBox-3">
              ...
              <div class="small-list">
                <div class="story" v-for="content in (videoData.content || '').slice(2,9)" :key="content.id">
                  <div class="story__thumb">
                    <a :href="content.url" target="_blank">
                      <img
                          :src="content.attachmentUrls ? content.attachmentUrls.length > 0 ? content.attachmentUrls[0].url : 'https://cdn.infocare.vn/10,5d58fbbcfd7e3df2f22a.jpg' : 'https://cdn.infocare.vn/10,5d58fbbcfd7e3df2f22a.jpg' "
...
export default {
  name: "Video",
  metaInfo:{
    title: 'Tin video - BAOMOI.COM',
    titleTemplate: null
  },
  data() {
    return {
      videoData:  [{image:{url: "../assets/logo.png"}}],
    }
  },
